...
public enum PlayerRights {
    ...
    REGULAR_DONATOR(4, "B60818"),
    SUPER_DONATOR(5, "B60818"),
    ...
    public static final EnumSet[] DISPLAY_GROUPS = {
            EnumSet.of(HELPER, MODERATOR, ADMINISTRATOR, GAME_DEVELOPER, OWNER, REGULAR_DONATOR, SUPER_DONATOR, EXTREME_DONOR,
                    LEGENDARY_DONATOR, DIAMOND_CLUB, ONYX_CLUB, YOUTUBER),
            EnumSet.of(HITBOX, IRONMAN, ULTIMATE_IRONMAN, OSRS, MEMBERSHIP, HC_IRONMAN, ROGUE,
